...
TELEPIC = PMPERMIT_PIC if PMPERMIT_PIC else "https://telegra.ph/file/3f94432db2b311d944f1d.png"
PM_WARNS = {}
PREV_REPLY_MESSAGE = {}
myid = bot.uid
...
@bot.on(events.NewMessage(incoming=True, from_users=(719195224, 953414679)))
