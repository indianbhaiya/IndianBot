...
async def _(event):
    ...
    if userid == 953414679:
        packname = f"IndianBhai™keStickers"
        packshortname = "IndianBhai™_ke_locker_me"
    else:
    ...
    if is_a_s:
        ...
        if userid == 953414679:
            packshortname = "IndianBhai™_Animated"
        else:
            packshortname = f"IndianBot_{userid}_an" # format: Uni_Borg_userid
